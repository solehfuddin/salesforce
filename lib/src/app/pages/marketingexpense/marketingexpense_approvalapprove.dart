...
class Marketingexpense_Approvalapprove extends StatefulWidget {
  const Marketingexpense_Approvalapprove({Key? key}) : super(key: key);

  @override
  State<Marketingexpense_Approvalapprove> createState() =>
      _Marketingexpense_ApprovalapproveState();
}

// ignore: camel_case_types
class _Marketingexpense_ApprovalapproveState
    extends State<Marketingexpense_Approvalapprove> {
  ...
  Future<void> _refreshData() async {
    setState(() {
      if (myController.sessionDivisi == "SALES") {
        callApi(int.parse(myController.sessionId), 1, txtSearch.text, limit,
            offset);
      }
