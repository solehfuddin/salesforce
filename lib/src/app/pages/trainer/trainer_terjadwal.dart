...
class TrainerTerjadwal extends StatefulWidget {
  const TrainerTerjadwal({Key? key}) : super(key: key);

  @override
  State<TrainerTerjadwal> createState() => _TrainerTerjadwalState();
}

class _TrainerTerjadwalState extends State<TrainerTerjadwal> {
