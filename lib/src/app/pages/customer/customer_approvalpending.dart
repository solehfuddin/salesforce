...
import 'package:sample/src/app/pages/customer/detail_changecustomer.dart';
...
class CustomerApprovalPending extends StatefulWidget {
  Color defaultColor;
  ...
  @override
  State<CustomerApprovalPending> createState() =>
      _CustomerApprovalPendingState();
}

class _CustomerApprovalPendingState extends State<CustomerApprovalPending> {
  ...
  getRole() async {
    ...
    setState(() {
      ...
      if (role == "ADMIN" && divisi == 'SALES') {
        callApi(int.parse(id!), false, 0, txtSearch.text, limit, offset);
      } else if (role == 'ADMIN' && divisi == 'AR') {
        callApi(0, true, 0, txtSearch.text, limit, offset);
      }
    });
  }
  ...
  void callApi(
    ...
    _listCustomer = service.getChangeCustomer(
      mounted,
      context,
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  // Center(
                                  //   child: Text(
                                  //     'Pembaruan Data Customer',
                                  //     style: TextStyle(
                                  //       fontSize: isHorizontal ? 15.sp : 11.sp,
                                  //       fontFamily: 'Montserrat',
  ...
  detailChangeContract(ChangeCustomer item, String div, String role) {
