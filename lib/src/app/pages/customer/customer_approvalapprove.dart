...
class CustomerApprovalApprove extends StatefulWidget {
  Color defaultColor;
  bool isPending;
  ...
  @override
  State<CustomerApprovalApprove> createState() =>
      _CustomerApprovalApproveState();
}

class _CustomerApprovalApproveState extends State<CustomerApprovalApprove> {
  ...
  getRole() async {
    ...
    setState(() {
      ...
      if (role == 'ADMIN' && divisi == 'SALES') {
        callApi(int.parse(id!), false, 1, txtSearch.text, limit, offset);
      }
      else if (role == 'ADMIN' && divisi == 'AR') {
        callApi(0, true, 1, txtSearch.text, limit, offset);
      }
    });
  }
