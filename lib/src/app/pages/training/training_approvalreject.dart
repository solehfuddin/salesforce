...
class Training_ApprovalReject extends StatefulWidget {
  const Training_ApprovalReject({Key? key}) : super(key: key);

  @override
  State<Training_ApprovalReject> createState() =>
      _Training_ApprovalRejectState();
}

// ignore: camel_case_types
class _Training_ApprovalRejectState extends State<Training_ApprovalReject> {
