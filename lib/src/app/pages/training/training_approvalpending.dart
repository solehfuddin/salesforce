...
class Training_ApprovalPending extends StatefulWidget {
  const Training_ApprovalPending({Key? key}) : super(key: key);

  @override
  State<Training_ApprovalPending> createState() => _Training_ApprovalPendingState();
}

// ignore: camel_case_types
class _Training_ApprovalPendingState extends State<Training_ApprovalPending> {
