                    ...
                    Text(
                      widget.contract!.approvalSm == "0"
                          ...
                          : widget.contract!.approvalSm == "1"
                              ? 'Disetujui oleh ${widget.contract!.salesManager == "" ? 'Sales Manager' : capitalize(widget.contract!.salesManager)} ${convertDateWithMonthHour(
                                  widget.contract!.dateApprovalSm,
                                  isPukul: true,
                                )}'
                              : 'Ditolak oleh ${widget.contract!.salesManager == "" ? 'Sales Manager' : capitalize(widget.contract!.salesManager)} ${convertDateWithMonthHour(
                                  widget.contract!.dateApprovalSm,
                                  isPukul: true,
                                )}',
                      style: TextStyle(
                    ...
                    Text(
                      widget.contract!.approvalAm == "0"
                          ...
                          : widget.contract!.approvalAm == "1"
                              ? 'Disetujui oleh ${widget.contract!.arManager == "" ? 'AR Manager' : capitalize(widget.contract!.arManager)} ${convertDateWithMonthHour(
                                  widget.contract!.dateApprovalAm,
                                  isPukul: true,
                                )}'
                              : 'Ditolak oleh ${widget.contract!.arManager == "" ? 'AR Manager' : capitalize(widget.contract!.arManager)} ${convertDateWithMonthHour(
                                  widget.contract!.dateApprovalAm,
                                  isPukul: true,
                                )}',
                      style: TextStyle(
